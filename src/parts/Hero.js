...
import BuildWebsite from "../assets/images/hero/t1resize.png";

export default function Hero() {
  return (
    <section className="hero">
      <div className="w-[70px] lg:w-1/2 xl:pl-12 sm:pr-2 mt-8">
        ...
        <p className="font-light text-xl text-gray-400 leading-relaxed mb-16">
          Platycerium Botanica lahir dari kecintaan terhadap keindahan dan keunikan</p>
        <Fade direction="up" delay={500} triggerOnce>4
          <Button
            href="/project"
            type="link"
